...
<div class="headerBar">
	<div class="topBar">
		<div class="comWidth">
			<div class="leftArea">
				<a href="#" class="collection">选择心仪的老师！</a>
			</div>
			<div class="rightArea">
				亲爱的 <?php echo $_COOKIE['username']?> 欢迎来到XIAO YU教育！
			</div>
		</div>
	</div>
	<div class="logoBar">
		<div class="comWidth">
			...
			<div class="shopCar fr">
				<span class="shopText fl">课程库</span>
	...
	<div class="navBox">
		<div class="comWidth clearfix">
			<div class="shopClass fl">
				<h3>全部课程分类<i class="shopClass_icon"></i></h3>
			...
			<ul class="nav fl">
				<li><a href="#" class="active">语言文学</a></li>
				<li><a href="#">前沿科技</a></li>
				<li><a href="#">娱乐风暴</a></li>
				<li><a href="#">社会大事件</a></li>
				<li><a href="#">特卖课程</a></li>
				<li><a href="#">现场讲座</a></li>
			</ul>
		</div>
