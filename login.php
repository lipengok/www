...
$usercode=rand(0,9)." ".rand(0,9)." ".rand(0,9)." ".rand(0,9);
$_SESSION['usercode']=str_replace(' ','',$usercode);
?>
<!DOCTYPE html>
<html>
	...
	<body style="background-color: #000000;">
		...
		<a id="Back_start_" class="btn btn-warning" style="width:100px;height:40px;border-radius: 0;" href="/index.html">返回</a>
		...
		<div id='_start'>
			...
			<div id="login_container">
				...
				<div id="form_container1">
					<br />
					<form action="php/controller/LoginController.php">
					<input type="text" class="form-control" placeholder="用户名" value="<?php echo isset($_COOKIE['username'])? $_COOKIE['username']:"" ?>" name="name" id="login_number"/>
					<input type="password" class="form-control" placeholder="密码" value="<?php echo isset($_COOKIE['psw'])? $_COOKIE['psw']:"" ?>" name="psw" id="login_password" />
			...
			<div id='regist_container' style="display: none;">
				...
				<form action="php/controller/RegistController.php">
					<div id="form_container2" style="padding-top: 25px;">
						<input type="text" class="form-control" placeholder="用户名" id="name" name="name"/>
						<input type="password" class="form-control" placeholder="密码" id="psw" name="psw" />
						<input type="password" class="form-control" placeholder="确认密码" id="regist_password2" name="check_psw" />
						<input type="text" class="form-control" placeholder="手机号" id="regist_phone" name="num" />
						<input type="text" class="form-control" placeholder="学校名称" name="school" />
						...
						<input id="getVCode" type="button" class="btn btn-success input_code" value="<?=$usercode?>" onclick="" />
